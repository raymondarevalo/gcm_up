...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyBAGpbsMNUA1vszSiGX_5ITLnrP6AO1b1k";
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyBAGpbsMNUA1vszSiGX_5ITLnrP6AO1b1k";
    ...
    public static void main(String[] args) {
        final String projectId = "731108673892";
        ...
        final String toRegId ="APA91bFikhYChGrgmvCvyJkjzKtpY6jQU52gMPCOQyh_sybvi8VHzAaSpdltxm4kN91l_FIycSJhFl0WjBzHtp2iNhqEbdRp8D8HLfghsUL1h-decayq4fgNXNimfIL6K16P8qFI0_ANv7GzN0UdOYILK7ILFMzQgg";
